...
export function genGptModelLayout(shape: IModelShape, gptGpuModel: IGptModelLink | null = null, offset: Vec3 = new Vec3(0, 0, 0)) {
    ...
    function createLayer(src: IBlkDef, target: IBlockLayerLink | undefined) {
        ...
        for (let i = 0; i < nHeads; i++) {
            ...
            let attnMtx = mk({
                ...
                transpose: true,
                name: LB('Attention Matrix', '注意力矩阵'),
            });
            ...
            let attnMtxSm = mk({
                ...
                special: BlkSpecial.Attention,
                transpose: true,
                name: LB('Attn Matrix Softmax', '注意力矩阵 Softmax'),
            });
        ...
        let vOutCombined = mk({
            ...
            dimX: DimStyle.T, dimY: DimStyle.C,
            hidden: true,
            name: LB('V Output Combined', 'V 输出合并'),
        });
        ...
        let projWeight = mk({
            ...
            dimX: DimStyle.C, dimY: DimStyle.C,
            name: LB('Projection Weights', '投影权重'),
        });
        ...
        let attnOut = mk({
            ...
            dimX: DimStyle.T, dimY: DimStyle.C,
            name: LB('Attention Output', '注意力输出'),
        });
        ...
        let attnResidual = mk({
            ...
            dimX: DimStyle.T, dimY: DimStyle.C,
            name: LB('Attention Residual', '注意力残差'),
        });
        ...
        let mlpFcBias = mk({
            ...
            name: LB('MLP Bias', 'MLP 偏置'), small: true,
        });
        ...
        let mlpProjWeight = mk({
            ...
            dimX: DimStyle.C4, dimY: DimStyle.C,
            name: LB('MLP Projection Weights', 'MLP 投影权重'),
        });
        ...
        let mlpProjBias = mk({
            ...
            dimX: DimStyle.None, dimY: DimStyle.C, small: true,
            name: LB('MLP Projection Bias', 'MLP 投影偏置'),
        });
    ...
    if (logitsTransposed) {
        lmHeadWeight = mk({
            ...
            dimX: DimStyle.n_vocab, dimY: DimStyle.C,
            name: LB('LM Head Weights', 'LM 头权重'),
        });
